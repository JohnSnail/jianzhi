...
-(UIToolbar *)setToolbarStyle{
    ...
    UIBarButtonItem *fixedSpace2 = [self barButtonSystemItem:UIBarButtonSystemItemFixedSpace];
    
    // 将宽度固定为35个像素
    fixedSpace2.width = 20;
    
    toolbar.items=@[flexSpacer,lefttem,centerSpace,right,fixedSpace2];
...
-(void)remove{
    ...
    newRect.origin.y = mainscreenhight - self.frame.size.height;
    self.frame = newRect;
    
    [UIView animateWithDuration:0.2f animations:^{
        CGRect newRect2 = self.frame;
        newRect2.origin.y = mainscreenhight;
        self.frame = newRect2;
...
-(void)show{
    ...
    CGRect newRect = self.frame;
    newRect.origin.y = mainscreenhight;
    self.frame = newRect;
    
    [UIView animateWithDuration:0.2f animations:^{
        CGRect newRect2 = self.frame;
        newRect2.origin.y = mainscreenhight - self.frame.size.height;
        self.frame = newRect2;
    } completion:^(BOOL finished) {
        ;
    }];
